            ...
            if (file_exists($conquistas_helper_path)) {
                try {
                    ...
                    if (function_exists('verificar_conquistas')) {
                        $resultado = verificar_conquistas($usuario_id_from_product);
                        if ($resultado['total'] > 0) {
                            log_process("Conquistas atribuídas: " . $resultado['total'] . " novas conquistas para usuário #{$usuario_id_from_product}");
                        }
                    }
                } catch (Exception $e) {
