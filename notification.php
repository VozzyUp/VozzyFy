                ...
                if ($should_process) {
                    ...
                    if (!empty($all_sales)) {
                        ...
                        if ($deve_disparar_eventos) {
                            ...
                            if ($gateway_detected === 'efi') $gateway_name_for_log = 'Efí Pix';
                            elseif ($gateway_detected === 'efi_card') $gateway_name_for_log = 'Efí Cartão';
